...
obj.test();//45//test是window下的方法，返回全局变量
...
obj.fun3 = fun1;
obj.fun4 = fun1();
console.log(obj.fun3());//输出什么//fun2()//ƒ fun2() {
        return this;//若改为 return this;
    }
console.log(obj.fun3()());//输出什么//45//window
console.log(obj.fun4());//输出什么//23//{x: 23, test: ƒ, sayHi: ƒ, fun3: ƒ, fun4: ƒ}
*/
