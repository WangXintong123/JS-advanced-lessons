...
var foo = function (a,b){
    ...
    //arguments 是Symbol类型，独一无二的，具体参见后续ES6部分//[1,2,3,4]
...
function checkVarCount(a, b) {
    if (checkVarCount.length !== arguments.length) {
        ...
        console.log(arguments.length);//1实参
        console.log(checkVarCount.length)//2形参
    }else{
...
swim(1,2);//  1 2
swim.call(me,3,4);//abc 3 4
bird.fly(5,6);//polly 5 6
bird.fly.call(me,7,8);//abc 7 8
bird.fly.apply(me,[7,8]);//abc 7 8
swim.call(null,1,2);// 1 2


//函数对象方法之 apply
//functionName.apply([thisObj[,argArray]])
//与call方法不同的地方是，apply的第二个参数类型必须是Array
swim.apply(me,[9,10]);//abc 9 10
bird.fly.apply(me,[11,12]);//abc 11 12
swim.apply(null,[13,14]);// 13 14
...
console.log(foo.toString()," ___ ",typeof foo.toString());//string
console.log(foo.valueOf()," ___ ",typeof foo.valueOf());//function

console.log(foo.hasOwnProperty("toString"));//f
console.log(Object.prototype.hasOwnProperty("toString"));//t

console.log(foo.hasOwnProperty("valueOf"));//f
console.log(Object.prototype.hasOwnProperty("valueOf"));//t
//关于toString与valueOf的详细内容参见JS对象相关章节
