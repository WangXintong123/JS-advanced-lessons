...
console.log(Object.keys(o3));//是否包含可枚举属性的键？y  包含
console.log(Object.getOwnPropertyNames(o3));//是否包含可枚举属性的键？x y x是不可枚举的
...
//in不关心是否可枚举，for in 关心是否可枚举
console.log(o3.hasOwnProperty("x"),o3.hasOwnProperty("y"));//是否关心可枚举 true true 不关心
...
);//多少个true 多少个false   f f t f   ？为什么a是false
console.log("a" in o5,"b" in o5,"c" in o5,"d" in o5);//多少个true 多少个false  t t t t 
