...
s2.name = "Colin";
s2.age = 23;
//会浪费内存，相当于给s1和S2每个对象都重新添加了name和age属性
 ...
 //以下写法实现了原型继承，但存在原型共享的问题
 //思考，name,age,id属性分别是添加到了那个对象上，这样写有什么问题？
 //name加到了person1上，age加到了person1.__proto__上，id加到了student1和student2上
 function Person(name){
 this.name = name;
 }
 Person.prototype.age = 22;
 ...
 //测试如下代码，思考为什么，这样的继承有什么弊端
 //定义在构造函数Person上的name属性和Person.prototype上的age属性的值一并被继承，不灵活
