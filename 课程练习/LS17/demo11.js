...
// Person.prototype = { //测试如果更改了Person.prototype输出又会变成什么?   true false true true
// 	getName:function(){}
// }
var p = new Person("jack");
console.log(p.__proto__ === Person.prototype);//true or false?   true
console.log(p.__proto__ === p.constructor.prototype);//true or false?    true
console.log(Object.prototype === p.constructor.prototype);//true or false?   false
console.log(({getName:function(){}}).__proto__ === p.constructor.prototype);//true or false?   false
