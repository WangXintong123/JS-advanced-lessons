...
var arr2 = new Array(5);//思考var arr2 = new Array("5");   长度为5的空数组
console.log(arr2);
...
//思考：点击document之后，arr22数组有几个元素，每个元素的值分别是什么？   有五个元素，q前四个为空，最后一个为5

var arr3 = new Array(1,2,3,4);//多个参数
console.log(arr1,arr2,arr3);//[1,2,3'4']   [,,,,5]  [1,2,3,4]
