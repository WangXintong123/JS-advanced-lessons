...
var date4 = new Date(1000); //1970-01-01:00:00:01   单位是毫秒
console.log(date4);//逆运算是date4.getTime();Thu Jan 01 1970 08:00:01 GMT+0800 (中国标准时间)

var date5 = new Date();//new Date(Date.now());
console.log(date5);//Sun May 05 2019 18:46:50 GMT+0800 (中国标准时间)
...
var d1 = new Date();
var d2 = Date();
console.log(d1,typeof d1);//object    由构造函数新建的对象
console.log(d2,typeof d2);//string
//创建的时间相同Sun May 05 2019 18:47:46 GMT+0800 (中国标准时间)

//补充思考
var n1 = new Number("123");
var n2 = Number("123");
console.log(n1,typeof n1);//object  构造函数实例化的的都是对象
