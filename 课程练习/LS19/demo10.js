...
console.log(new Date().toISOString());//2019-05-05T01:03:51.912Z
...
console.log(new Date().toISOString());//2019-05-05T01:05:20.903Z
...
console.log(new Date(new Date().getTime()+50*(new Date("1970-01-02").getTime())));
