...
console.log(reg1.lastIndex, "__", ret1);//0 ___ ["1a2", "a", index: 0, input: "1a2b3c4d5e", groups: undefined]
ret1 = reg1.exec(ts1);
console.log(reg1.lastIndex, "__", ret1);//非全局返回结果相同  0 ___ ["1a2", "a", index: 0, input: "1a2b3c4d5e", groups: undefined]
...
console.log(reg2.lastIndex, "__", ret2);//3___["1a2", "a", index: 0, input: "1a2b3c4d5e", groups: undefined]
ret2 = reg2.exec(ts2);//全局模式下lastIndex起作用
console.log(reg2.lastIndex, "__", ret2);//7 ___ ["3c4", "c", index: 4, input: "1a2b3c4d5e", groups: undefined]
...
var oTxt = document.getElementById("txt");
        ...
        var str="测试<a href = http://www.baidu.com/>笔试</a> <a href = http://www.edu2act.cn/>笔试</a>正则";
 
        var pattern=/w{3}\.\w{5-7}\.\w{3-2}/;
