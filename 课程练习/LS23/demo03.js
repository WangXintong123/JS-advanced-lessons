...
console.log(jsonStrArr1);//[1,"x",true,{"y":2,"z":3}]  字符串
console.log(a1);//(4) [1, "x", true, {…}]    数组
...
console.log(o3);//c:[3,4,"x",{"y":34,"z":56}]    {a: Array(2), b: true, c: Array(4), d: 5, e: {…}}
console.log(o4);// [1, "x", true, {…}]
console.log(o5);//c:[3,4,"x",{"y":34,"z":56}]    {a: Array(2), b: "ChangeToString", c: Array(4)}
