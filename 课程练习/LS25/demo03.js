...
//自定义事件（创建、分发、捕获的综合案例）   dispatchEvent() 方法给节点分派一个合成事件。
window.onload = function (e) {
    var div1 = document.getElementById("div1");
    var div2 = document.getElementById("div2");
    var eventHandler = function (e) {
        ...
        var myEvent = new Event("MyEvent");
         div2.dispatchEvent(myEvent);//若改我div1分发的话会怎样  document handler  body handler  div2 listener MyEvent
    ...
    },false);//若第3个可选参数为true的话会怎样，那个会输出，理解冒泡和捕获  都会输出  
